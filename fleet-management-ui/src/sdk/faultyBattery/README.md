...
var api = new OpenApiDefinition.BatteryFaultControllerApi()
var opts = {
...
api.getBatteryFaults(opts, callback);
...
------------ | ------------- | ------------- | -------------
*OpenApiDefinition.BatteryFaultControllerApi* | [**getBatteryFaults**](docs/BatteryFaultControllerApi.md#getBatteryFaults) | **GET** /api/faults | 


## Documentation for Models

 - [OpenApiDefinition.BatteryFaultModel](docs/BatteryFaultModel.md)
