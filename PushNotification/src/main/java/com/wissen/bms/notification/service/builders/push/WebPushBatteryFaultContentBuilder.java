...
@Component
public class WebPushBatteryFaultContentBuilder implements NotificationContentBuilder<BatteryFault> {
    ...
    public NotificationType getNotificationType() {
        return NotificationType.WEB_PUSH;  // Specify that this builder is for email notifications
    }
