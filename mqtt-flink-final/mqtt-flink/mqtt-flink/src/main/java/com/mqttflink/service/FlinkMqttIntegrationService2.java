...
@Service
@Slf4j
public class FlinkMqttIntegrationService2 {

    TeleRuleEngineService service;
    ...
    public void process() throws Exception {
        ...
        DataStream<String> mqttStream = env.addSource(new FlinkMqttIntegrationService2.MqttSource(mqttUrl, mqttTopic));
        ...
        mqttStream
                ...
                .timeWindow(Time.seconds(1)) // Create a 10-second tumbling window
