...
//            triggerReplenishment(station);
    ...
    public Station findNearestStation(String gps) {
        ...
        // Calculate the nearest station with available stock
        return stations.stream()
                // Filter stations that have available stock greater than 0
                .filter(station -> station.getAvailableStock() > 0)
                ...
                .orElse(null); // Return null if no station with available stock is found
    }
