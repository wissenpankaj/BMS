...
//    private double soc;         // State of Charge in %
//    private double soh;         // State of Health in %
//    private double voltageDeviation; // in %
//    private int chargeCycles;   // Number of charge-discharge cycles
//
//    // Constructor
//    public TelemetryData() {
//    }
//
//    public TelemetryData(String vehicleId, Double voltage, Double current, Double dischargeRate, double temperature, double soc, double soh, double voltageDeviation, int chargeCycles) {
//        this.vehicleId = vehicleId;
//        this.voltage = voltage;
//        this.current = current;
